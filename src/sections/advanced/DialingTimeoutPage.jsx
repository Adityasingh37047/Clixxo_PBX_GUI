  ...
  return (
    ...
    >
      <div className="w-full max-w-full">
        ...
        <div className="rounded-b-lg bg-white border-2 border-gray-400 border-t-0 shadow-sm">
          <div className="rounded-b-lg w-full flex flex-col overflow-hidden">
        ...
        >
          <div className="flex flex-col gap-2 w-full">
            ...
            >
              <label
                className="text-[14px] text-gray-700 font-medium whitespace-nowrap text-left"
                style={{ width: 220, marginRight: 10, flexShrink: 0 }}
              >

  ...
  const handleSave = () => {
    ...
    if (!formData.routeSelf) {
      if (!formData.destinationAddress || formData.destinationAddress === "") {
        errors.destinationAddress = "Please enter a Destination Address!";
      } else if (!validateIPAddress(formData.destinationAddress)) {
        errors.destinationAddress = "Please enter a valid Destination Address!";
      }
      if (!formData.destinationPort || formData.destinationPort === "") {
        errors.destinationPort = "Please enter a Destination Port!";
      }
    }
                ...
                <FieldRow label="Destination Address:">
                  <div>
                    <input
                      ...
                      style={{
                        ...inputStyle,
                        borderColor: !!validationErrors.destinationAddress ? C.errorRed : C.cardBorder,
                      }}
                    />
                ...
                <FieldRow label="Destination Port:">
                  <div>
                    <input
                      ...
                      style={{
                        ...inputStyle,
                        borderColor: !!validationErrors.destinationPort ? C.errorRed : C.cardBorder,
                      }}
                    />
                    {validationErrors.destinationPort && (
                      <div style={{ color: C.errorRed, fontSize: 11, marginTop: 2 }}>
                        {validationErrors.destinationPort}
                      </div>
                    )}

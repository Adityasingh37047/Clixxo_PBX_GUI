...
// import { listNumberManipulations, createNumberManipulation, updateNumberManipulation, deleteNumberManipulation, listPstnGroups } from './controller';
                    ...
                    >
                      <thead>
                        <tr style={{ minHeight: 32 }}>
                          {PSTN_CALL_IN_CALLERID_TABLE_COLUMNS.map((c) => (
                            <th
                              key={c.key}

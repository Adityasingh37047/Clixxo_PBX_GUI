...
export const ROUTE_PSTN_IP_PAGE_BREADCRUMB_ROOT = "FXS";
export const ROUTE_PSTN_IP_PAGE_BREADCRUMB_SECTION = "Route";
export const ROUTE_PSTN_IP_PAGE_TITLE = "Tel->IP Routing Rule";
export const ROUTE_PSTN_IP_EMPTY_MESSAGE = "No rules configured!";
export const ROUTE_PSTN_IP_MODAL_TITLE_ADD = "Add Tel->IP Routing Rule";
export const ROUTE_PSTN_IP_MODAL_TITLE_EDIT = "Edit Tel->IP Routing Rule";

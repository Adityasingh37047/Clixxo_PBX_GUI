...
export const PSTN_CALL_IN_CALLERID_FIELDS = [
  ...
  {
    name: "with_original_calleeid",
    label: "With Original CalleeID:",
    type: "select",
    options: [
      { value: "Yes", label: "Yes" },
      { value: "No", label: "No" },
...
export const NUM_MANIPULATE_PSTN_CALL_IN_CALLERID_PAGE_BREADCRUMB_ROOT =
  "E1-PRI";
export const NUM_MANIPULATE_PSTN_CALL_IN_CALLERID_PAGE_BREADCRUMB_SECTION =
  "Num Manipulate";
export const NUM_MANIPULATE_PSTN_CALL_IN_CALLERID_PAGE_TITLE =
  "PSTN Call In CallerID";
export const NUM_MANIPULATE_PSTN_CALL_IN_CALLERID_EMPTY_MESSAGE =
  "No PSTN call in caller ID rules found.";
export const NUM_MANIPULATE_PSTN_CALL_IN_CALLERID_MODAL_TITLE_ADD =
  "Add PSTN Call In CallerID";
export const NUM_MANIPULATE_PSTN_CALL_IN_CALLERID_MODAL_TITLE_EDIT =
  "Edit PSTN Call In CallerID";
export const NUM_MANIPULATE_PSTN_CALL_IN_CALLERID_ADD_NEW_LABEL = "+ Add New";
export const NUM_MANIPULATE_PSTN_CALL_IN_CALLERID_ADD_NEW_EMPTY_LABEL =
  "+ Add New Rule";
export const NUM_MANIPULATE_PSTN_CALL_IN_CALLERID_SAVE_LABEL = "Save";
export const NUM_MANIPULATE_PSTN_CALL_IN_CALLERID_CLOSE_LABEL = "Close";

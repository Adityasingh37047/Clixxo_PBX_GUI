...
export const ROUTE_PATHS = {
  ...
  CERTIFICATE_MANAGE: '/maintenance/system-tools/certificate-manage',
  RADIUS: '/maintenance/system-tools/radius',
  SIP_ACCOUNT_GENERATOR: '/maintenance/system-tools/sip-account-generator',
  ...
  DEVICE_LOCK: '/maintenance/system-tools/device-lock',
  RESTART: '/maintenance/system-tools/restart',
  LICENCE: '/maintenance/system-tools/licence',
  SQL_UPLOAD: '/maintenance/system-tools/sql-upload',

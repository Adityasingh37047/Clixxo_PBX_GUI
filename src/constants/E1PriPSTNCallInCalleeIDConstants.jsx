...
export const NUM_MANIPULATE_PSTN_CALL_IN_CALLEEID_PAGE_BREADCRUMB_ROOT =
  "E1-PRI";
export const NUM_MANIPULATE_PSTN_CALL_IN_CALLEEID_PAGE_BREADCRUMB_SECTION =
  "Num Manipulate";
export const NUM_MANIPULATE_PSTN_CALL_IN_CALLEEID_PAGE_TITLE =
  "PSTN Call In CalleeID";
export const NUM_MANIPULATE_PSTN_CALL_IN_CALLEEID_EMPTY_MESSAGE =
  "No PSTN call in callee ID rules found.";
export const NUM_MANIPULATE_PSTN_CALL_IN_CALLEEID_MODAL_TITLE_ADD =
  "Add PSTN Call In CalleeID";
export const NUM_MANIPULATE_PSTN_CALL_IN_CALLEEID_MODAL_TITLE_EDIT =
  "Edit PSTN Call In CalleeID";
export const NUM_MANIPULATE_PSTN_CALL_IN_CALLEEID_ADD_NEW_LABEL = "+ Add New";
export const NUM_MANIPULATE_PSTN_CALL_IN_CALLEEID_ADD_NEW_EMPTY_LABEL =
  "+ Add New Rule";
export const NUM_MANIPULATE_PSTN_CALL_IN_CALLEEID_SAVE_LABEL = "Save";
export const NUM_MANIPULATE_PSTN_CALL_IN_CALLEEID_CLOSE_LABEL = "Close";

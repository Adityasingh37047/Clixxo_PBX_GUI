/**
 * MUI OutlinedInput + native fill-box borders (PBX Extension Group › Group Name).
 */

export const OUTLINED_BORDER = "rgba(0, 0, 0, 0.23)";
export const OUTLINED_HOVER = "rgba(0, 0, 0, 0.87)";
export const OUTLINED_FOCUS = "#1976d2";
...
/** Modal / form TextField — 32px height */
...
/** Native &lt;select&gt; — no fixed height so option text is not clipped */
...
export const getNativeFieldInteraction = (disabled) =>

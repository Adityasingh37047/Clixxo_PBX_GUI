...
const Btn = ({
  ...
  return (
    <button
      ...
      onMouseEnter={(e) => {
        if (!disabled) {
          e.currentTarget.style.backgroundColor = "#DCE6F2";
        }
      }}
      onMouseLeave={(e) => {
        if (!disabled) {
...
const statusStyle = (s) => {
  ...
  if (v === "online") return { color: "#15803d" };
  if (v === "offline") return { color: "#dc2626" };
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {loading.delete ? (
                  <CircularProgress size={11} style={{ color: "#1e293b" }} />
                ) : (
                  "🗑 "
                )}
                Delete

...
const RouteIPIPPage = () => {
  ...
  const pagedIndices = pagedRules.map(
    (_, idx) => (page - 1) * itemsPerPage + idx,
  );
  const allPageSelected =
    pagedIndices.length > 0 &&
    pagedIndices.every((idx) => selected.includes(idx));

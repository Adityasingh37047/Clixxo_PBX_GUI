...
const InfoTableRow = ({ label, value, keyName, even }) => (
  <div
    style={{
      ...
      minHeight: 28,
      alignItems: "center",
      background: even ? "#f3f4f6" : "#ffffff",
    }}
  >
    <span
      style={{ color: C.labelText, fontSize: 12, width: "42%", flexShrink: 0 }}
    >
      {label}
    </span>
    <span style={{ color: C.valueText, fontSize: 12, flex: 1 }}>
    ...
    >
      <div style={{ maxWidth: "100%", margin: "0 auto" }}>
        ...
        <div style={{ fontSize: 11, color: "#94a3b8", marginBottom: 12 }}>
          Status &rsaquo; System Status &rsaquo;{" "}
          <span style={{ color: "#1e293b", fontWeight: 600 }}>System Info</span>
        </div>

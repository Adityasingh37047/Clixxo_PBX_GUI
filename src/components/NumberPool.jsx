...
const legacyModalButtonBar = {
  display: "flex",
  justifyContent: "center",
  gap: 18,
  marginTop: 8,
};
const legacySaveButton = {
  background: "linear-gradient(to bottom, #3bb6f5 0%, #0e8fd6 100%)",
  color: "#fff",
  fontWeight: 600,
  fontSize: 15,
...
const NumberPool = () => {
  ...
  const thumbHeight =
    scrollState.height && scrollState.scrollHeight
      ? Math.max(
          30,
          (scrollState.height / scrollState.scrollHeight) * thumbArea,
        )
      : 30;
  ...
  const thumbTop =
    ...
    scrollState.scrollHeight > scrollState.height
      ? (scrollState.top / (scrollState.scrollHeight - scrollState.height)) *
        maxThumbTop
      : 0;
    ...
    <div className="bg-gray-50 min-h-[calc(100vh-80px)] p-2 md:p-2">
              ...
              <thead>
                <tr>
                  <th
                    ...
                    style={{ padding: "6px 8px", height: 32, minWidth: "90px" }}
                  >
                    Check
                  </th>
                  <th
      ...
      >
        ...
        <DialogContent className="bg-gray-200 flex flex-col gap-3 py-4">
          ...
          {validationError && (
            <div className="text-red-500 text-sm mt-2 mb-1 text-center">
              {validationError}
            </div>
          )}
        </DialogContent>

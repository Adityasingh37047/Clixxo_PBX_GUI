    ...
    <div className="bg-gray-50 min-h-[calc(100vh-80px)] p-2 sm:p-4 md:p-6">
      ...
      >
        ...
        <DialogActions className="flex justify-center gap-6 pb-4">
          ...
          <button
            className="bg-gradient-to-b from-[#d1d5db] to-[#9ca3af] text-[#fff] font-semibold text-s rounded px-3 py-1 min-w-[100px] shadow hover:from-[#9ca3af] hover:to-[#d1d5db] disabled:opacity-50 disabled:cursor-not-allowed"

...
const RoutePstnToIPPage = () => {
  ...
  const handleSave = async () => {
    ...
    if (!formData.callInitiator) {
      errors.callInitiator = "Call Initiator is required.";
    }
                          ...
                          <MuiSelect
                            ...
                            sx={{
                              ...
                              "& .MuiOutlinedInput-notchedOutline": {
                                borderColor: !!validationErrors[field.key] ? C.errorRed : C.cardBorder,
                              },
                        ...
                        <TextField
                          ...
                          sx={{
                            "& .MuiOutlinedInput-root": {
                              "& fieldset": { borderColor: !!validationErrors[field.key] ? C.errorRed : C.cardBorder },

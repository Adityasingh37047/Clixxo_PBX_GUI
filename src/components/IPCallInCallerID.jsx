...
const IPCallInCallerID = () => {
  ...
  const handleSave = async () => {
    ...
    if (!formData.with_original_calleeid) {
      errors.with_original_calleeid = "With Original CalleeID is required.";
    }
    ...
    try {
      ...
      if (editIndex !== null) {
        ...
        if (response.response) {
          ...
          setModalError(response.message || "Failed to update number manipulation");
        }
      } else {
        // Create new
        ...
        if (response.response) {
          ...
          setModalError(response.message || "Failed to create number manipulation");
        }
      }
    } catch (error) {
      ...
      if (error.message === "Network Error") {
        ...
        setModalError(error.message || "Failed to save number manipulation");
      }
    } finally {

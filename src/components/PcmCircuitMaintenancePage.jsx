...
const PcmCircuitMaintenancePage = () => {
  ...
  const renderPcmMaintenance = () => (
    <div className="mb-3 w-full max-w-full mx-auto md:p-2">
      <div
        className="rounded-t-lg w-full h-8 bg-gradient-to-b from-[#b3e0ff] via-[#6ec1f7] to-[#3b8fd6] flex items-center justify-center font-semibold text-lg text-white shadow mb-0"
        style={{
          background: "linear-gradient(#3E5475 100%)",
          boxShadow: "0 2px 8px 0 rgba(80,160,255,0.10)",
        }}

    ...
    >
      <div className="w-full" style={{ maxWidth: 1000 }}>
        ...
        <div style={tableContainerStyle}>
          ...
          <form onSubmit={handleLock} style={{ padding: "32px 24px", maxWidth: 600, margin: "0 auto" }}>
              ...
              <div className="flex justify-center gap-8 mb-8 flex-wrap">
                {DEVICE_LOCK_OPTIONS.map((opt) => (
                  <label
                    ...
                    onMouseOver={(e) => (e.currentTarget.style.color = C.strongText)}
                    onMouseOut={(e) => (e.currentTarget.style.color = C.labelText)}
                  >
                    <input
                      type="checkbox"

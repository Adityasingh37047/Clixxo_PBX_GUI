  ...
  return (
    <div className="bg-gray-50 min-h-[calc(100vh-80px)] p-4 flex flex-col items-center md:p-2">
      <div className="w-full max-w-4xl mx-auto">
        ...
        <div className="w-full bg-gradient-to-b from-[#b3e0ff] via-[#6ec1f7] to-[#3b8fd6] h-8 flex items-center justify-center font-semibold text-lg text-white shadow mb-0 border-t-2 border-x-2 border-gray-400 rounded-t-xl">
          IDS Settings
        </div>

        <form
          onSubmit={handleSave}
          className="w-full bg-white border-x-2 border-b-2 border-gray-400 rounded-b-xl flex flex-col gap-0 px-2 md:px-8 py-6"
        >
          <div className="w-full max-w-3xl mx-auto">
            {/* Enable Checkbox */}
            <div className="flex flex-col sm:flex-row items-start sm:items-center mb-6 w-full gap-2 pl-2 md:pl-8">
              <span className="text-base font-medium text-gray-700 min-w-[140px]">
                IDS Settings:
              </span>
      ...
      <div className="w-full max-w-4xl mx-auto mt-8">
        ...
        {/* Log Display Area */}
        <div
          className="w-full bg-white border-x-2 border-b-2 border-gray-400 rounded-b-xl overflow-hidden resize-y"

...
const LoginPage = () => {
  ...
  if (isLoading) {
    ...
    toastColor = "#1d4ed8";
    toastIcon = "⏳";
    toastText = "Connecting to server...";
  } else if (lockMessage) {
    toastBg = "#fef2f2";
    toastBorder = "#fca5a5";
    toastColor = "#b91c1c";
    toastIcon = "🔒";
    toastText = lockMessage;
    ...
    toastColor = "#92400e";
    toastIcon = "⚠️";
    toastText = `Invalid credentials — ${attemptsLeft} attempt${attemptsLeft !== 1 ? "s" : ""} left`;
    toastDismiss = () => {
      setAttemptsLeft(null);
      setError("");
    };
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow:
                    isLoading || serverStatus === "offline"
                      ? "none"
                      : "0 2px 8px rgba(21,96,168,0.35)",
                  transition: "all 0.15s",
                }}
                onMouseEnter={(e) => {
                  if (!isLoading && serverStatus !== "offline")

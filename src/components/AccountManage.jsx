        ...
        >
          <div style={blueBarStyle}>
            ...
            >
              ...
              <Btn
                variant="cancel"
                onClick={() => { if (!canWrite) { showReadOnlyToast(); return; } handleDelete(); }}
              ...
              <Btn
                variant="primary"
                onClick={() => { if (!canWrite) { showReadOnlyToast(); return; } handleOpenModal(); }}
                disabled={loading}
                      ...
                      >
                        ...
                        <td style={tdStyle}>
                          <EditDocumentIcon
                            ...
                            titleAccess="Edit"
                            style={{ cursor: canWrite ? 'pointer' : 'not-allowed', opacity: canWrite ? 0.7 : 0.3, color: '#2563eb' }}
                            onClick={() => {
                              if (!canWrite) { showReadOnlyToast(); return; }
                              if (item.isAdmin) {
                                showToast(

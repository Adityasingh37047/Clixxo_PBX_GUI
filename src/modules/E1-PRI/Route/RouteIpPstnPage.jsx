...
const ROUTE_IP_PSTN_ADD_NEW_DIALOG_MARGIN = 24;
const ROUTE_IP_PSTN_ADD_NEW_DIALOG_LAYOUT_OFFSET = 80;

const ROUTE_IP_PSTN_ADD_NEW_DIALOG_SX = {
  "& .MuiDialog-container": {
    alignItems: "center",
...
const ROUTE_IP_PSTN_ADD_NEW_DIALOG_PAPER_SX = {
  margin: ROUTE_IP_PSTN_ADD_NEW_DIALOG_MARGIN,
  maxHeight: `calc(100vh - ${ROUTE_IP_PSTN_ADD_NEW_DIALOG_LAYOUT_OFFSET}px - ${ROUTE_IP_PSTN_ADD_NEW_DIALOG_MARGIN * 2}px)`,
  display: "flex",
...
const routeIpPstnPageInnerStyle = {
  width: "100%",
  maxWidth: "100%",
  margin: "0 auto",
};
...
const routeIpPstnCardStyle = {
  background: "#ffffff",
  borderRadius: ROUTE_IP_PSTN_CARD_RADIUS,
  overflow: "hidden",
  border: `1px solid ${C.cardBorder}`,
  boxShadow: "0 0 14px rgba(0, 0, 0, 0.18), 0 0 5px rgba(0, 0, 0, 0.10)",
};

const routeIpPstnToolbarStyle = {
  display: "flex",
  alignItems: "center",
  ...
  flexWrap: "wrap",
  gap: 12,
  borderTopLeftRadius: ROUTE_IP_PSTN_CARD_RADIUS,
  borderTopRightRadius: ROUTE_IP_PSTN_CARD_RADIUS,
};

const routeIpPstnPaginationStyle = {
  display: "flex",
  alignItems: "center",
  justifyContent: "space-between",
  padding: "7px 14px",
  ...
  borderBottomLeftRadius: ROUTE_IP_PSTN_CARD_RADIUS,
  borderBottomRightRadius: ROUTE_IP_PSTN_CARD_RADIUS,
  overflow: "hidden",
};

const routeIpPstnSelectedBadgeStyle = {
  background: "#eff6ff",
  color: C.accent,
  fontSize: 11,
  fontWeight: 700,
...
const routeIpPstnCancelBtnStyle = {
  height: 30,
  background: "#cbd5e1",
  color: "#374151",
  border: "1px solid #cbd5e1",
...
const routeIpPstnPrimaryBtnStyle = {
  height: 30,
  padding: "6px 14px",
  fontSize: 12,
  borderRadius: 10,
...
const routeIpPstnModalCancelBtnStyle = {
  minWidth: 100,
  height: 33,
  background: "#cbd5e1",
  color: "#374151",
...
const RouteIpPstnBreadcrumb = () => (
  ...
  >
    <span>{ROUTE_IP_PSTN_PAGE_BREADCRUMB_ROOT}</span>
    <span>&gt;</span>
    <span>{ROUTE_IP_PSTN_PAGE_BREADCRUMB_SECTION}</span>
    <span>&gt;</span>
...
const RouteIpPstnPagination = ({
  page,
  totalPages,
  recordCount,
  onPageChange,
}) => (
  <div style={routeIpPstnPaginationStyle}>
    ...
    <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
      ...
      <span style={routeIpPstnPageBadgeStyle}>
...
const routeIpPstnTableCheckboxSx = {
  padding: "1px",
  color: "#3E5475",
  ...
  return (
    <div style={routeIpPstnPageWrapStyle}>
      ...
      <Dialog
        ...
        maxWidth={false}
        sx={ROUTE_IP_PSTN_ADD_NEW_DIALOG_SX}
        PaperProps={{
          sx: ROUTE_IP_PSTN_ADD_NEW_DIALOG_PAPER_SX,
        }}
        disableRestoreFocus
        disableEnforceFocus
      >
        ...
        >
          ...
          <Btn
            ...
            disabled={loading.save}
            style={{ ...routeIpPstnModalCancelBtnStyle, height: 34 }}
          >
            {ROUTE_IP_PSTN_CLOSE_LABEL}
          </Btn>
        </DialogActions>

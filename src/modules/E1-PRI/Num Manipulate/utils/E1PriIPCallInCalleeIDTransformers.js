export const E1_PRI_IP_CALL_IN_CALLEEID_DISPLAY_COLUMNS = [
...
export const normalizeE1PriIPCallInCalleeIDFormDigits = (formData) => ({
  ...formData,
...
export const E1PriIPCallInCalleeIDFormFromRow = (item) =>
  normalizeE1PriIPCallInCalleeIDFormDigits({ ...item });

export const buildE1PriIPCallInCalleeIDUpdatePayload = (normalized, editId) => ({
  id: editId,
...
export const renderE1PriIPCallInCalleeIDCellValue = (col, item) => {

export const E1_PRI_IP_CALL_IN_ORICALLEEID_DISPLAY_COLUMNS = [
...
export const normalizeE1PriIPCallInOriCalleeIDFormDigits = (formData) => ({
  ...formData,
...
export const E1PriIPCallInOriCalleeIDFormFromRow = (item) =>
  normalizeE1PriIPCallInOriCalleeIDFormDigits({
    ...item,
    with_original_calleeid: item.with_original_calleeid || "No",
  });

export const buildE1PriIPCallInOriCalleeIDUpdatePayload = (
  normalized,
  editId,
) => ({
  id: editId,
...
export const renderE1PriIPCallInOriCalleeIDCellValue = (col, item) => {

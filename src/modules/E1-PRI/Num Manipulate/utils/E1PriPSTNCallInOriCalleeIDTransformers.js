export const normalizeE1PriPSTNCallInOriCalleeIDFormDigits = (formData) => ({
  ...formData,
...
export const E1PriPSTNCallInOriCalleeIDFormFromRow = (item) =>
  normalizeE1PriPSTNCallInOriCalleeIDFormDigits({
    ...item,
    with_original_calleeid: item.with_original_calleeid || "No",
  });

export const buildE1PriPSTNCallInOriCalleeIDUpdatePayload = (normalized, editId) => ({
  id: editId,
...
export const formatE1PriPSTNCallInOriCalleeIDDisplayValue = (
  key,
  value,
  rowIndex,
  page,
...
export const getE1PriPSTNCallInOriCalleeIDPcmGroupIdLabel = (groupId, pcmTrunkGroups) => {
...
export const getE1PriPSTNCallInOriCalleeIDUpdatedFields = (fields, pcmTrunkGroups) =>
  fields.map((field) => {
...
export const buildDefaultE1PriPSTNCallInOriCalleeIDForm = (initialForm, pcmTrunkGroups) => {

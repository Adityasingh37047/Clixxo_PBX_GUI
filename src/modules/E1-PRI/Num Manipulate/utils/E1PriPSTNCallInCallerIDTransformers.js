export const normalizeE1PriPSTNCallInCallerIDFormDigits = (formData) => ({
  ...formData,
...
export const E1PriPSTNCallInCallerIDFormFromRow = (item) =>
  normalizeE1PriPSTNCallInCallerIDFormDigits({
    ...item,
  });

export const buildE1PriPSTNCallInCallerIDUpdatePayload = (normalized, editId) => ({
  id: editId,
...
export const formatE1PriPSTNCallInCallerIDDisplayValue = (
  key,
  value,
  rowIndex,
  page,
...
export const getE1PriPSTNCallInCallerIDPcmGroupIdLabel = (groupId, pcmTrunkGroups) => {
...
export const getE1PriPSTNCallInCallerIDUpdatedFields = (fields, pcmTrunkGroups) =>
  fields.map((field) => {
...
export const buildDefaultE1PriPSTNCallInCallerIDForm = (initialForm, pcmTrunkGroups) => {

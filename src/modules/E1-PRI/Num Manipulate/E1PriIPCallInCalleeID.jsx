...
import {
  ...
  NUM_MANIPULATE_IP_CALL_IN_CALLEEID_PAGE_BREADCRUMB_ROOT,
  NUM_MANIPULATE_IP_CALL_IN_CALLEEID_PAGE_BREADCRUMB_SECTION,
  NUM_MANIPULATE_IP_CALL_IN_CALLEEID_PAGE_TITLE,
  NUM_MANIPULATE_IP_CALL_IN_CALLEEID_EMPTY_MESSAGE,
  ...
  NUM_MANIPULATE_IP_CALL_IN_CALLEEID_ADD_NEW_EMPTY_LABEL,
...
const E1_PRI_IP_CALL_IN_CALLEE_ID_ADD_NEW_DIALOG_MARGIN = 24;
const E1_PRI_IP_CALL_IN_CALLEE_ID_ADD_NEW_DIALOG_LAYOUT_OFFSET = 80;

const E1_PRI_IP_CALL_IN_CALLEE_ID_ADD_NEW_DIALOG_SX = {
  "& .MuiDialog-container": {
    alignItems: "center",
...
const E1_PRI_IP_CALL_IN_CALLEE_ID_ADD_NEW_DIALOG_PAPER_SX = {
  margin: E1_PRI_IP_CALL_IN_CALLEE_ID_ADD_NEW_DIALOG_MARGIN,
  maxHeight: `calc(100vh - ${E1_PRI_IP_CALL_IN_CALLEE_ID_ADD_NEW_DIALOG_LAYOUT_OFFSET}px - ${E1_PRI_IP_CALL_IN_CALLEE_ID_ADD_NEW_DIALOG_MARGIN * 2}px)`,
  display: "flex",
...
const IPCallInCalleeIdBreadcrumb = () => (
  ...
  >
    <span>{NUM_MANIPULATE_IP_CALL_IN_CALLEEID_PAGE_BREADCRUMB_ROOT}</span>
    <span>&gt;</span>
    <span>{NUM_MANIPULATE_IP_CALL_IN_CALLEEID_PAGE_BREADCRUMB_SECTION}</span>
    <span>&gt;</span>
  ...
  return (
    ...
    >
      ...
      <Dialog
        ...
        maxWidth={false}
        sx={E1_PRI_IP_CALL_IN_CALLEE_ID_ADD_NEW_DIALOG_SX}
        PaperProps={{
          sx: E1_PRI_IP_CALL_IN_CALLEE_ID_ADD_NEW_DIALOG_PAPER_SX,
        }}
        disableRestoreFocus
        disableEnforceFocus
      >

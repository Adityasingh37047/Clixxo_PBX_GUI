...
import {
  ...
  NUM_MANIPULATE_PSTN_CALL_IN_CALLERID_PAGE_BREADCRUMB_ROOT,
...
const E1_PRI_PSTN_CALL_IN_CALLER_ID_ADD_NEW_DIALOG_MARGIN = 24;
const E1_PRI_PSTN_CALL_IN_CALLER_ID_ADD_NEW_DIALOG_LAYOUT_OFFSET = 80;

const E1_PRI_PSTN_CALL_IN_CALLER_ID_ADD_NEW_DIALOG_SX = {
  "& .MuiDialog-container": {
    alignItems: "center",
...
const E1_PRI_PSTN_CALL_IN_CALLER_ID_ADD_NEW_DIALOG_PAPER_SX = {
  margin: E1_PRI_PSTN_CALL_IN_CALLER_ID_ADD_NEW_DIALOG_MARGIN,
  maxHeight: `calc(100vh - ${E1_PRI_PSTN_CALL_IN_CALLER_ID_ADD_NEW_DIALOG_LAYOUT_OFFSET}px - ${E1_PRI_PSTN_CALL_IN_CALLER_ID_ADD_NEW_DIALOG_MARGIN * 2}px)`,
  display: "flex",
...
const Breadcrumb = () => (
  ...
  >
    <span>{NUM_MANIPULATE_PSTN_CALL_IN_CALLERID_PAGE_BREADCRUMB_ROOT}</span>
    <span>&gt;</span>
    <span>{NUM_MANIPULATE_PSTN_CALL_IN_CALLERID_PAGE_BREADCRUMB_SECTION}</span>
    <span>&gt;</span>
  ...
  return (
    <div style={pageWrapStyle}>
      <div style={pageInnerStyle}>
        ...
        <div style={cardStyle}>
          ...
          {loading.fetch ? (
            ...
            <TableListEmptyState
              message={NUM_MANIPULATE_PSTN_CALL_IN_CALLERID_EMPTY_MESSAGE}
      ...
      <Dialog
        ...
        maxWidth={false}
        sx={E1_PRI_PSTN_CALL_IN_CALLER_ID_ADD_NEW_DIALOG_SX}
        PaperProps={{
          sx: E1_PRI_PSTN_CALL_IN_CALLER_ID_ADD_NEW_DIALOG_PAPER_SX,
        }}
        disableRestoreFocus
        disableEnforceFocus
      >

...
const E1_PRI_PSTN_CALL_IN_CALLEE_ID_ADD_NEW_DIALOG_MARGIN = 24;
const E1_PRI_PSTN_CALL_IN_CALLEE_ID_ADD_NEW_DIALOG_LAYOUT_OFFSET = 80;

const E1_PRI_PSTN_CALL_IN_CALLEE_ID_ADD_NEW_DIALOG_SX = {
  "& .MuiDialog-container": {
    alignItems: "center",
...
const E1_PRI_PSTN_CALL_IN_CALLEE_ID_ADD_NEW_DIALOG_PAPER_SX = {
  margin: E1_PRI_PSTN_CALL_IN_CALLEE_ID_ADD_NEW_DIALOG_MARGIN,
  maxHeight: `calc(100vh - ${E1_PRI_PSTN_CALL_IN_CALLEE_ID_ADD_NEW_DIALOG_LAYOUT_OFFSET}px - ${E1_PRI_PSTN_CALL_IN_CALLEE_ID_ADD_NEW_DIALOG_MARGIN * 2}px)`,
  display: "flex",
  ...
  return (
    <div style={pageWrapStyle}>
      ...
      <Dialog
        ...
        maxWidth={false}
        sx={E1_PRI_PSTN_CALL_IN_CALLEE_ID_ADD_NEW_DIALOG_SX}
        PaperProps={{
          sx: E1_PRI_PSTN_CALL_IN_CALLEE_ID_ADD_NEW_DIALOG_PAPER_SX,
        }}
        disableRestoreFocus
        disableEnforceFocus
      >

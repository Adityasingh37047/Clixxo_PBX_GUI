...
const FXS_IP_CALL_IN_CALLER_ID_ADD_NEW_DIALOG_MARGIN = 24;
const FXS_IP_CALL_IN_CALLER_ID_ADD_NEW_DIALOG_LAYOUT_OFFSET = 80;

const FXS_IP_CALL_IN_CALLER_ID_ADD_NEW_DIALOG_SX = {
  "& .MuiDialog-container": {
    alignItems: "center",
...
const FXS_IP_CALL_IN_CALLER_ID_ADD_NEW_DIALOG_PAPER_SX = {
  margin: FXS_IP_CALL_IN_CALLER_ID_ADD_NEW_DIALOG_MARGIN,
  maxHeight: `calc(100vh - ${FXS_IP_CALL_IN_CALLER_ID_ADD_NEW_DIALOG_LAYOUT_OFFSET}px - ${FXS_IP_CALL_IN_CALLER_ID_ADD_NEW_DIALOG_MARGIN * 2}px)`,
  display: "flex",
  ...
  return (
    <div style={ipCallInCallerIdPageWrapStyle}>
      ...
      <Dialog
        ...
        sx={FXS_IP_CALL_IN_CALLER_ID_ADD_NEW_DIALOG_SX}
        PaperProps={{
          sx: FXS_IP_CALL_IN_CALLER_ID_ADD_NEW_DIALOG_PAPER_SX,
        }}
        disableRestoreFocus
        disableEnforceFocus
      >

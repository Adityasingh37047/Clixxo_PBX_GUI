import { PSTN_CALL_IN_CALLERID_INITIAL_FORM } from "../../../../constants/FxsPSTNCallInCallerIDConstants";

export const normalizePSTNCallInCallerIDFormDigits = (formData) => ({
  ...formData,
...
export const PSTNCallInCallerIDFormFromRow = (item) =>
  normalizePSTNCallInCallerIDFormDigits({ ...item });

export const buildPSTNCallInCallerIDUpdatePayload = (normalized, editId) => ({
  id: editId,
...
export const renderPSTNCallInCallerIDCellValue = (col, item, pcmTrunkGroups, getPcmGroupIdLabel) => {
...
export const getPSTNCallInCallerIDPcmGroupIdLabel = (groupId, pcmTrunkGroups) => {
...
export const getPSTNCallInCallerIDUpdatedFields = (fields, pcmTrunkGroups) =>
  fields.map((field) => {
...
export const buildDefaultPSTNCallInCallerIDForm = (initialForm, pcmTrunkGroups) => {

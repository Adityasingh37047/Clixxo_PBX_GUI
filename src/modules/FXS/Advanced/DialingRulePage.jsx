...
import {
  ...
  DIALING_RULE_PAGE_BREADCRUMB_ROOT,
...
const dialingRulePageWrapStyle = {
...
const dialingRulePageInnerStyle = {
  width: "100%",
  maxWidth: "100%",
  margin: "0 auto",
  display: "flex",
...
const dialingRuleTableBodyStyle = {
  overflowX: "auto",
  overflowY: "auto",
  width: "100%",
};

const dialingRulePaginationStyle = {
  display: "flex",
  alignItems: "center",
  justifyContent: "space-between",
  padding: "10px 28px",
...
const DialingRuleBreadcrumb = () => (
  ...
  >
    <span>{DIALING_RULE_PAGE_BREADCRUMB_ROOT}</span>
    <span>&gt;</span>
    <span>{DIALING_RULE_PAGE_BREADCRUMB_SECTION}</span>
    <span>&gt;</span>

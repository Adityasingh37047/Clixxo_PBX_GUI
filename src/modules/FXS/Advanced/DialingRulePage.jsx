...
const dialingRuleModalTitleStyle = {
  background: "#1e2d42",
  color: "#ffffff",
  fontWeight: 600,
  fontSize: 16,
...
const dialingRuleModalContentStyle = {
  padding: "20px 24px",
  paddingBottom: "16px",
  backgroundColor: "#ffffff",
};

const dialingRuleModalFormPanelStyle = {
  display: "flex",
...
const dialingRuleModalFooterStyle = {
  display: "flex",
  justifyContent: "center",
  gap: 12,
  padding: "10px 16px",
...
const DIALING_RULE_TH_GAP = { padding: "8px 14px" };
const DIALING_RULE_TD_GAP = { padding: "6px 14px", lineHeight: 1.2 };
const DIALING_RULE_CHECKBOX_SX = {
  padding: "1px",
  color: "#3E5475",
...
const DialingRulePagination = ({
  ...
  <div className={DIALING_RULE_PAGINATION}>
...
const DialingRulePage = () => {
  ...
  return (
    <div className={DIALING_RULE_PAGE_WRAP}>
      <div className={DIALING_RULE_PAGE_INNER}>
        {toast.msg && (
          <Alert
            severity={toast.type}
        ...
        <FxsAdvancedBreadcrumb current="Dialing Rule" />

        <div className={DIALING_RULE_CARD}>
          <div className={DIALING_RULE_TOOLBAR}>
            <div className={DIALING_RULE_TOOLBAR_LEFT}>
              {selected.length > 0 && (
                <span className={DIALING_RULE_SELECTED_BADGE}>
                  {selected.length} selected
                </span>
              )}
            </div>
            <div className={DIALING_RULE_TOOLBAR_ACTIONS}>
              <Btn
                variant="cancel"
          ...
          <div style={{ overflowX: "auto", overflowY: "auto", flex: 1 }}>
            {rules.length === 0 ? (
              <div className="flex min-h-[240px] flex-col items-center justify-center p-[24px] text-center">
                <div className="mb-[16px] text-[13px] font-semibold text-[#3E5475]">
                  ...
                  <tr>
                    ...
                    >
                      <Checkbox
                        ...
                        sx={DIALING_RULE_CHECKBOX_SX}
                      />
                    </TH>
                    {DATA_COLUMNS.map((col) => (
                      <TH key={col.key} style={DIALING_RULE_TH_GAP}>
                        {col.label}
                      </TH>
                    ))}
                    <TH
        ...
        <Dialog
          ...
          maxWidth={false}
          PaperProps={{ sx: dialingRuleModalPaperSx }}
          disableRestoreFocus
          disableEnforceFocus
        >
          <DialogTitle style={dialingRuleModalTitleStyle}>
            {editIndex !== null ? "Edit Dialing Rule" : "Add Dialing Rule"}
          </DialogTitle>
          <DialogContent style={dialingRuleModalContentStyle}>
            <div style={dialingRuleModalFormPanelStyle}>
          ...
          <DialogActions style={dialingRuleModalFooterStyle}>

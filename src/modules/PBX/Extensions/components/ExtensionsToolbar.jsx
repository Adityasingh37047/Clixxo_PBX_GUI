...
function ExtensionsToolbar(props) {
  const {
    isCompact, selected, searchQuery, setSearchQuery, setPage, setSelected,
    handleDelete, loading, setShowImportModal, setImportFile, handleExport,
    openBulkModal, handleOpenModal,
  } = props;
  return (
          <div
            style={{

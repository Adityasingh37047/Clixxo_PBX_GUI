...
const pickupGroupDualListSelectStyle = {
  width: "100%",
  height: 160,
...
const PICKUP_GROUP_DUAL_LIST_BTN =
...
const PickupGroupDualListBtn = ({ onClick, title, children }) => (
  <button type="button" title={title} onClick={onClick} className={PICKUP_GROUP_DUAL_LIST_BTN}>
    {children}
  </button>
);
...
// ── Local page shell UI ───────────────────────────────────────────────────────
const PICKUP_GROUP_PAGE_WRAP =
  "bg-[var(--bg-main)] min-h-[calc(100vh-80px)] p-[16px] box-border";
const PICKUP_GROUP_PAGE_INNER = "w-full max-w-full mx-auto";
const PICKUP_GROUP_CARD =
...
const PICKUP_GROUP_TOOLBAR_COMPACT = "flex-col items-stretch gap-[10px]";
const PICKUP_GROUP_TOOLBAR_LEFT = "flex flex-wrap items-center gap-[8px]";
const PICKUP_GROUP_TOOLBAR_ACTIONS = "flex flex-wrap items-center gap-[8px]";
const PICKUP_GROUP_SELECTED_BADGE =
  "rounded-full border border-[#3E5475] bg-[#e0f2fe] px-[12px] py-[5px] text-[11px] font-bold text-[var(--text-label)]";
const PICKUP_GROUP_PAGE_BADGE =
  "rounded-[6px] border-[0.5px] border-[var(--border-strong)] bg-[#e0f2fe] px-[14px] py-[5px] text-[11px] font-semibold text-[var(--text-label)]";
const PICKUP_GROUP_PAGINATION =
...
const PickupGroupPagination = ({
  ...
  <div className={PICKUP_GROUP_PAGINATION}>
    ...
    <div className="flex items-center gap-[8px]">
      ...
      <span className={PICKUP_GROUP_PAGE_BADGE}>
...
const FieldRow = ({ label, children, required }) => (  <div
...
const PickupGroup = () => {
  ...
  return (
    <div className={`${PICKUP_GROUP_PAGE_WRAP} ${isCompact ? "p-[8px]" : ""}`.trim()}>
      <div className={PICKUP_GROUP_PAGE_INNER}>
        ...
        {/* Main Card */}
        <div className={PICKUP_GROUP_CARD}>
          <div
            className={`${PICKUP_GROUP_TOOLBAR} ${isCompact ? PICKUP_GROUP_TOOLBAR_COMPACT : ""}`.trim()}
          >
            <div className={PICKUP_GROUP_TOOLBAR_LEFT}>
              {selected.length > 0 && (
                <span className={PICKUP_GROUP_SELECTED_BADGE}>
                  {selected.length} selected
                </span>
              )}
            </div>

            <div className={PICKUP_GROUP_TOOLBAR_ACTIONS}>
              <Btn
                  ...
                  >
                    <div>
                      ...
                      <select
                        ...
                        style={pickupGroupDualListSelectStyle}
                      >
                        {loading.extensions ? (
                    ...
                    >
                      <PickupGroupDualListBtn onClick={addSelectedMembers}>
                        &gt;
                      </PickupGroupDualListBtn>
                      <PickupGroupDualListBtn onClick={addAllMembers}>
                        &gt;&gt;
                      </PickupGroupDualListBtn>
                      <PickupGroupDualListBtn onClick={removeSelectedMembers}>
                        &lt;
                      </PickupGroupDualListBtn>
                      <PickupGroupDualListBtn onClick={removeAllMembers}>
                        &lt;&lt;
                      </PickupGroupDualListBtn>
                    </div>
                    <div>

...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "/sip/sip-trunk",
        element: <Navigate to={ROUTE_PATHS.GLOBAL_SIP} replace />,
      },
      ...
      },
      {
        ...
        element: <FxsIPCallInCalleeID />,
      },
      {
        path: ROUTE_PATHS.FXS_PSTN_CALL_IN_CALLERID,
        element: <FxsPSTNCallInCallerID />,
      },
      {
